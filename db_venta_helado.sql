...
insert into Rol_Usuario(nombre_rol) value("Administrador");
...
insert into Categoria(nombre_categoria,descripcion_categoria) values('Helado de Fruta','descripcion 2');
insert into Categoria(nombre_categoria,descripcion_categoria) values('Raspadillas','descripcion 3');
insert into Categoria(nombre_categoria,descripcion_categoria) values('Helado de Cono','descripcion 4');
insert into Categoria(nombre_categoria,descripcion_categoria) values('Marcianos','descripcion 5');
insert into Categoria(nombre_categoria,descripcion_categoria) values('Helado de Espuma','descripcion 6');
