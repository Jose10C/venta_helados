                ...
                <div class="col-lg-4 col-12">
                    <div class="single-head">
                        ...
                        <div class="single-info">
                            ...
                            <ul>
                                <li><a href="mailto:jaimecarrascotaipe@gmail.com"><?php echo $item['email1_empresa'] ?></a></li>
                                <li><a href="mailto:heladeria_ice_cream@gmail.com"><?php echo $item['email2_empresa'] ?></a></li>
                            </ul>
                        </div>
                        <div class="single-info">
